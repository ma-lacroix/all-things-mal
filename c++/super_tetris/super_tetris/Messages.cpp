...
Message::Message(sf::Font c_font,int c_size,std::string c_message,sf::Vector2f c_position,float c_speed){
    ...
    n8.loadFromFile(resourcePath() + "sounds/n_good.wav");
    n_good.setBuffer(n8);
    n_good.setVolume(90);
    
    n9.loadFromFile(resourcePath() + "sounds/n_all_right.wav");
    n_all_right.setBuffer(n9);
    n_all_right.setVolume(90);
    
    n10.loadFromFile(resourcePath() + "sounds/n_yyy.wav");
    n_yyy.setBuffer(n10);
    n_yyy.setVolume(90);
    
    n11.loadFromFile(resourcePath() + "sounds/n_onbc.wav");
